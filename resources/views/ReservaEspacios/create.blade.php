      ...
      <form id="formuploadajax">
        <div id="secction1" style="display: ">
          ...
          <div class="row">
            ...
            @endif
                  ...
                  <input type="hidden" id="capacidadSpace" name="capacidadSpace" value="" class="form-control" >
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="secction2" style="display: none;">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="number" value="0" name="inmob[{{$valueInv['inv_uID']}}][]" min="1" max="{{$valueInv['inv_number']}}" >
          </div>
          </div>
          @endforeach
          @endif
          ...
          <div class="row">
            ...
            <div class="col-md-6 text-right">
              <div class="form-group">
                <button type="button" class="btn btn-primary px-5 py-2" onClick="sendForm();">Continuar</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn waves-effect waves-light" id="button" style="color: white;" onClick="reservar();">Reservar espacios disponibles</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
            ...
            .done(function(data) {
			 var text = "";
   				...
   				text += "<row>";
					...
					text += "<h3 class='zilla'>Lugar reservado <span  style='color: "+data[0].color +";'>"+data[0].place+"</span></h3>";
